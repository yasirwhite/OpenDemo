#!/usr/bin/env node
/**
 * render.mjs — drives the React text layer frame by frame.
 *
 ...
 *
 * Usage:
 *   node text-layer/render.mjs [--out text-layer.mp4] [--fps 30] [--sheet]
 *   node text-layer/render.mjs --at 3.2 --png frame.png
 */
...
const OUT = opt("--out", resolve(__dirname, "..", "mem-text.mp4"));
